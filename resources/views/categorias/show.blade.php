    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6">
                    <h3 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $categoria->nombre }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 mt-2">{{ $categoria->descripcion }}</p>
                </div>
                ...
                @if($productos->isEmpty())
                    <p class="text-gray-600 dark:text-gray-400">No hay productos relacionados en esta categoría.</p>
                @else
                ...
                <!-- Botón de Volver -->
                <div class="mt-6">
                    <a href="{{ route('categorias.index') }}" class="btn-action bg-blue-700">Volver a Categorías</a>
                </div>
            </div>
        </div>
    </div>
